...
const content = `# TRACE Application - Complete Logic & Mapping Summary
...
fs.writeFileSync('trace-logic-summary-complete.md', content);
console.log('Markdown generated. Converting to PDF...');

try {
  execSync('npx -y md-to-pdf trace-logic-summary-complete.md');
  console.log('PDF generated successfully as trace-logic-summary-complete.pdf.');
} catch (e) {
