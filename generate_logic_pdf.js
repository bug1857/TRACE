...
const content = `# TRACE Application - Important Logic & Math Formulas
...
fs.writeFileSync('trace-logic-summary.md', content);
console.log('Markdown generated. Converting to PDF...');

try {
  execSync('npx -y md-to-pdf trace-logic-summary.md');
  console.log('PDF generated successfully as trace-logic-summary.pdf.');
} catch (e) {
